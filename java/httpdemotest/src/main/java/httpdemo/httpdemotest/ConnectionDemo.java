...
public class ConnectionDemo {
	...
	public static void main(String[] args) {
		String url = "http://open.fangjia.com/accessToken";//url
    	String username = "testUseName";//您的用户名
    	String password = "1234321";// 房价网提供给您密码
    	String appKey = "fdafdddddddfdassffffffffffa";//房价网提供给您的appKey
		//发送get方式调用api
		System.out.println(requestMethod("GET", url, "username="+username+"&password="+password+"&appKey="+appKey));
	}
